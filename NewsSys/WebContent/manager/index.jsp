...
<title><fmt:message key="index_title"></fmt:message></title>
...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="right">
<div >
	<fmt:message key="index_change"></fmt:message>：&nbsp;<a href="country?language=zh">中文</a>&nbsp;&nbsp;&nbsp;<a href="country?language=ja">日文</a>&nbsp;&nbsp;
    <fmt:message key="index_loginPlease"></fmt:message>[<a  href="${path }/manager/login.jsp"><fmt:message key="index_login"></fmt:message></a>]。
...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25" align="right"><fmt:message key="index_cpright"></fmt:message></td>
  </tr>
</table>
</body>
</html>
